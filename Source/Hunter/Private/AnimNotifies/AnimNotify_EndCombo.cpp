...
#include "AnimNotifies/AnimNotify_EndCombo.h"
#include "HBaseCharacter.h"
#include "Components/HCombatComponent.h"

void UAnimNotify_EndCombo::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	if (!MeshComp) { return; }
	...
	CombatComponent->Notify_OnEndCombo();
}
